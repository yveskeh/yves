...
void show(void)
{
  ...
  LCD_ShowString(82,260,tftlcd_data.width,tftlcd_data.height,16,"Speed:");
	LCD_ShowString(145,260,tftlcd_data.width,tftlcd_data.height,16,"00");
	LCD_ShowString(42,283,tftlcd_data.width,tftlcd_data.height,16,"The speed is changing");
	LCD_ShowString(10,320,tftlcd_data.width,tftlcd_data.height,16,"K_UP: UP");
	LCD_ShowString(10,340,tftlcd_data.width,tftlcd_data.height,16,"KEY1: DOWN");
	LCD_ShowString(10,360,tftlcd_data.width,tftlcd_data.height,16,"KEY2: LEFT");
	LCD_ShowString(10,380,tftlcd_data.width,tftlcd_data.height,16,"KEY0: RIGHT");
}
